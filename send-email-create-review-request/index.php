<?php
    ...
    if ($domain != '' && !(ctype_space($domain))
        ...
        $message .= "<head>\r\n";
        $message .= "<title>" . $name . ", thank you for your feedback.</title>\r\n";
        $message .= "</head>\r\n";
        $message .= "<body>\r\n";
        $message .= "<style>\r\n";
	...
	$message .= "<div style=\"text-align: left\">\r\n";
        ...
        $message .= "<p><a href='" . $domain . "/product-reviews" . $forward_slash_or_html .
                "?code=" . $security_code . "&review=" . $row_id . "&product=" . $item_id . "&sort=Low%20to%20high&perpage=10&pagenum=1&showreview=Show&search=Search'>Make review public</a></p>\r\n";
        $message .= "</div>\r\n";
        $message .= "<div style=\"text-align: left\">\r\n";
